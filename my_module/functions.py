...
def topic_1():
    ...
    #will indefinitly ask for user for length of password until a number is an input
...
def topic_2():
    ...
    #will indefinitily ask user for input until user inputs an int
    # an error message will show prompting user to choose again, if it is not an int
    while not input_decoded.isnumeric():
        if input_decoded != '1':
            print("Invalid input. Please press 1 to continue or any number to exit to the topic menu")
        input_decoded = input("Would you like to check if your message can be decoded? \n" 
                              "Press 1 for yes to continue \n" 
                              "Press any number to go back to the topic menu \n") 
